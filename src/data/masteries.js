let masteries = {
  "data": {
    ...
    "6263": {
      "description": [
        `Gain 5% total health.
        Your movement impairing effects brand enemy champions with an earthen rune for 4 seconds. Other allied champions who attack branded enemies heal for 5 + 2.5% of your maximum health over 2 seconds (halved if you are ranged).`
    ],
      "id": 6263,
        "name": "Stoneborn Pact"
    },
